...
namespace badEngine {
	...
	namespace EFM {
		...
		public:
			...
			void wipeMemory();
			EDM::Player* createPlayer(HKey::ENTITY_TYPE key)const;			//caller is the owner, can return nullptr
			EDM::Enemy*  createEnemy(HKey::ENTITY_TYPE key)const;			//caller is the owner, can return nullptr
